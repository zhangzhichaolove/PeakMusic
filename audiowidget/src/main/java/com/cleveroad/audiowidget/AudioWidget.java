...
public class AudioWidget {
    ...
    private class PlayPauseButtonCallback extends TouchManager.SimpleCallback {
        ...
        public void onClick(float x, float y) {
            ...
            if (onControlsClickListener != null) {
                onControlsClickListener.onPlayPauseClicked(false);
            }
        }
    ...
    private class OnControlsClickListenerWrapper implements OnControlsClickListener {
        ...
        public boolean onPlayPauseClicked(boolean isPlay) {
            if (onControlsClickListener == null || !onControlsClickListener.onPlayPauseClicked(playbackState.state() != Configuration.STATE_PLAYING)) {
...
//        }
    ...
    public interface OnControlsClickListener {
         ...
         */
        boolean onPlayPauseClicked(boolean isPlay);
